...
def generate_sub_table_sql(subPageUrl, subTitle):
    ...
    # try:
    #     procName = soup.find('h2').get_text()
    # except:
    #     try:
    #         procName = soup.find('h2', id='ipo-').get_text()
    #     except:
    #         procName = soup.find('h2', id='a-').get_text()
    procName = soup.find('h2').get_text()
    print(procName, tableName)
...
def main():
    ...
    for subItem in subPageUrlList:
        ...
        generate_sub_table_sql(subPageUrl, subTitle)
