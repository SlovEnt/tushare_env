...
def get_tpdatas_news(cFlag, q, inputCode, startDay, endDay):
    argsDict = {}
    ...
    strSqlList = tp2.get_tpdatas_news(argsDict)
...
def run_m_get_news_info():
    ...
    newsSrcList = tp2.get_datas_for_db_sys_dict("news_src")

    for newsSrc in newsSrcList:
        for dateYMD in dateYMDList:
            p.apply_async(func=get_tpdatas_news, args=("0", q, newsSrc["dict_item"], dateYMD["start_date"], dateYMD["end_date"]))
